...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_SAMPLE_ASSISTANCE_NRF_CLOUD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_SAMPLE_LTE_ON_DEMAND, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CLOUD_AGPS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRF_CLOUD_REST_LOG_LEVEL_DEFAULT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODEM_ANTENNA_GNSS_EXTERNAL, 1);
