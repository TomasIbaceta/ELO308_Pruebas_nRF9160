...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_SAMPLE_MODE_PERIODIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_SAMPLE_PERIODIC_INTERVAL, 10);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GNSS_SAMPLE_PERIODIC_TIMEOUT, 500);
